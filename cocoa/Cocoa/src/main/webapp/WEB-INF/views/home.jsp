...
<script>
	$(document).ready(function() {
		...
		$('#coaching').click(function() {
			...
			$('#coach_cate').removeAttr('hidden');
			$('#project_cate').attr('hidden');
            ...
            <div class="col mb-5">
               <div class="card h-100">
                  ...
                  <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                     <div class="text-center">
                        <a class="btn btn-outline-dark mt-auto" href="${contextPath}/view_projectInfo?id=${project.leader}&projectNO=${project.projectNO}">Get in</a>
                     </div>
                  </div>
               </div>
            </div>
						...
						<div class="card h-100">
							...
							<div class="card-body p-4">
								<div class="text-center">
									...
									${project.leader}<br>
									<!-- 기본요금 -->
									${project.level}<br> ${project.memberCount}명
								</div>
							</div>
