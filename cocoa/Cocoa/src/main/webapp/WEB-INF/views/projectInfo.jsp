			...
			<div class="container main-secction">
				<div class="row">
							...
							<div class="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center" 
								...
								<br><span style="float:right;">
									<a href="/cocoa/view_reviewInfo">
										<input type="button" name="view_reviewInfo" value="후기"
								...
								<!-- leader -->
								<input type="text" name="leader" value="${projectInfo.leader}" readonly
									style="text-align: center; border: 0; background-color:#FFEBCD;"><br><br>
									
								<!-- kakao -->
								<!-- 네이버 대신 카톡링크 -->
								<a href="${projectInfo.kakao }">
									<input type="button" name="kakaoLink" value="kakao"
									style="text-align: center; border: 1; background-color:#FFEBCD;">
								</a><br><br>
								
								<!-- 본인이면 수정(submit) / 삭제(버튼) 표시 -->
								<!-- submit이 2개라서 formaction 사용 (post 방식) -->
								<c:choose>
	       							<c:when test="${isLogOn == true && member.id ==projectInfo.leader}">
					...
					<div class="card" style="width: 50rem; border:1px solid; background-color:#FFCC99">
						...
						<!-- pImg -->
						<div align="center">
							<br><img id="preview" src="${contextPath}/download?leader=${projectInfo.leader}&pImg=${projectInfo.pImg}&projectNO=${projectInfo.projectNO}"
							 width=100%
								height=500 style="border:1px solid;"/><br><br>
							</div>
						...
						<div class="project">
							...
							<!-- pTitle 표시 -->
							<hr><input name="pTitle" type="text" value="${projectInfo.pTitle}"
								style="border: 0; text-align: center; width: 100%; background-color:#FFCC99;"><hr>
							
							<!-- memberCount 표시 -->
							인원 : <input name="memberCount" type="text" value="${projectInfo.memberCount}"
									style="border: 0; width:5%; text-align: center; background-color:#FFCC99;">
									<b>명</b><hr>
	
							<!-- level 표시 -->
							난이도 : <input name="level" type="text" value="${projectInfo.level}"
							...
							세부 내용 : <br><br>
								...
								placeholder="${projectInfo.pContents}"
